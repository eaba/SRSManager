...
namespace SrsConfFile.SRSConfClass
{
    ...
    public class SrsSystemConfClass : SrsConfBase
    {
        ...
        private SrsPulsarConfClass? pulsar;
        ...
        private string? server_id; //srs-ie193id
        private bool? in_docker;
        private bool? query_latest_version;
        private ushort? first_wait_for_qlv;
        ...
        public SrsPulsarConfClass? Pulsar
        {
            get => pulsar;
            set => pulsar = value;
        }
        ...
        public bool? In_Docker
        {
            get => in_docker;
            set => in_docker = value;
        }
        
        public bool? Query_Latest_Version
        {
            get => query_latest_version;
            set => query_latest_version = value;
        }
       
        public ushort? First_Wait_For_Glv
        {
            get => first_wait_for_qlv;
            set => first_wait_for_qlv = value;
        }
