...
namespace SrsApis.SrsManager.Apis
{
    public static class OnvifMonitorApis
    {
        ...
        /// <summary>
        /// Initialize all uninitialized onvif cameras
        /// </summary>
        /// <param name="rs"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Use ip address/instance name to get onvif device instance
        /// </summary>
        /// <param name="instanceIpaddr"></param>
        /// <param name="rs"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Get the ip address/instance name of all onvif cameras
        /// </summary>
        /// <param name="rs"></param>
        /// <returns></returns>
