...
namespace SrsApis.SrsManager.Apis
{
    public class VhostSecurityApis
    {
        ...
        /// <param name="rs"></param>
        /// <returns></returns>
        public static bool DeleteVhostSecurity(string deviceId, string vhostDomain, out ResponseStruct rs)
        {
        ...
        /// <param name="rs"></param>
        /// <returns></returns>
        public static Security GetVhostSecurity(string deviceId, string vhostDomain, out ResponseStruct rs)
        {
            rs = new ResponseStruct()
            {
                Code = ErrorNumber.None,
        ...
        /// <returns></returns>
        public static bool SetVhostSecurity(string deviceId, string vhostDomain, Security security,
