...
namespace SrsApis.SrsManager.Apis
{
    public static class VhostBandcheckApis
    {
        ...
        /// <param name="rs"></param>
        /// <returns></returns>
        public static bool DeleteVhostBandcheck(string deviceId, string vhostDomain, out ResponseStruct rs)
        {
        ...
        /// <param name="rs"></param>
        /// <returns></returns>
        public static Bandcheck GetVhostBandcheck(string deviceId, string vhostDomain, out ResponseStruct rs)
        {
            rs = new ResponseStruct()
            {
                Code = ErrorNumber.None,
        ...
        /// <param name="rs"></param>
        /// <returns></returns>
        public static bool SetVhostBandcheck(string deviceId, string vhostDomain, Bandcheck bandcheck,
